  ...
  <div class="modal-dialog" role="document">
    ...
    <script>
      ...
      function deleteProduct(ProductId) {
        $.ajax({
          url: '/videos/students/clear/' + ProductId,
          type: 'GET',
          data: {
            _token: '{{ csrf_token() }}'
          },
          ...
          error: function(response) {
            ...
            // Here, you can access the response properties, if needed, like:
            console.log(response.status); // HTTP status code
            console.log(response.responseText); // The response body
