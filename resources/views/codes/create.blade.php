            ...
            <div class="container-fluid flex-grow-1 container-p-y">
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form id="generateCodesForm" action="/codes" method="POST" enctype="multipart/form-data" >
                      @csrf
                      <div class="d-flex justify-content-between">
                        <div class="mb-3 w-50">
                          <label class="form-label" for="basic-default-fullname">Number Of Codes</label>
                          <input type="number" class="form-control" id="basic-default-fullname" placeholder="Enter Number of Codes" name="numberOfCodes">
                          @error('numberOfCodes')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>  
                        <div class="mb-3 w-50">
                          <label class="form-label" for="basic-default-fullname">Codes Value</label>
                          <input type="number" class="form-control" id="basic-default-fullname" placeholder="Enter value of codes" name="value">
                          @error('value')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>  
              ...
              <div class="m-2" id="loader" style="display: none; text-align:center">
              ...
              <div class="col-xl">
                <div class="card ">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <button id="downloadExcelBtn" class="btn btn-outline-danger btn-sm">Excel File</button>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive text-nowrap" id="codesTable">
                      <table class="table">
                        <thead>
                          <tr>
                            <th>code</th>
                        ...
                        <tbody class="table-border-bottom-0" id="codesTableBody">
                          @if (isset($codes))
      ...
      form.addEventListener('submit', function(event) {
        ...
        axios.post('/codes', formData)
          .then(function(response) {
            ...
            // Iterate over the codes and create new table rows
          ...
          .catch(function(error) {
            console.error(error);
            // Hide the loading element in case of error
            loader.style.display = 'none';
          });
      });
    </script>
...
<script>
  document.getElementById('downloadExcelBtn').addEventListener('click', function() {
    ...
    const table = document.querySelector('#codesTable table');
