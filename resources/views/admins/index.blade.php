          ...
          @foreach ($users as $user)
            <tr id="deleteRow{{$user->id}}">
              ...
              <td class="text-center">
                <div class="btn-group">
                  <form action="/admin/product/{{$user->id}}" method="POST">
                    @method('DELETE')
                    @csrf
                    <a href="/admins/{{$user->id}}/edit" type="button" class="btn btn-outline-primary btn-sm">Edit</a> <!-- Added btn-sm class -->
                    <button type="button" onclick="showConfirmationModal({{$user->id}})" class="btn btn-outline-danger btn-sm">Delete</button>
                  </form>
              </div>
              </td>
            </tr>
