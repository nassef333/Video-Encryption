                    ...
                    <form action="/admin/submit" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="d-flex">
                        <div class="mb-3 w-100">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="First Name" name="fname" required>
                          @error('fname')
                        ...
                        <div class="mb-3 w-100">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Last Name" name="lname" required>
                          @error('lname')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>  
                      ...
                      <div class="d-flex">
                        <div class="mb-3 w-100">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Phone" name="email" required>
                          @error('email')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>
