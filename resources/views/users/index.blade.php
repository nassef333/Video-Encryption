              ...
              <td class="text-center">
                <div class="btn-group">
                  <form action="/admin/product/{{$user->id}}" method="POST">
                    @method('DELETE')
                    @csrf
                    <a href="/users/{{$user->id}}/edit" type="button" class="btn btn-outline-primary btn-sm">Edit</a> <!-- Added btn-sm class -->
                    <a href="/users/{{$user->id}}/profile" type="button" class="btn btn-outline-dark btn-sm">Profile</a> <!-- Added btn-sm class -->
