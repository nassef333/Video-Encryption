              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-4">Edit {{$question->name}}</h4>
                    <small class="text-muted float-end">Edit question</small>
                  </div>
                  <div class="card-body">
                    <form action="/questions/{{$question->id}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <div id="imagePreview" class="overflow-hidden">
                          <img src="{{ asset("storage/".$question->img)}}" alt="{{ $question->question }}" style="width: 100%; height: auto;">
                        </div> 
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" id="basic-default-fullname" placeholder="Question" name="question" rows="4">{{ $question->question }}</textarea>
                        @error('question')
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-control" id="basic-default-fullname" name="level">
                          <option value="1" {{ $question->level == 1 ? 'selected' : '' }}>الأول الثانوي</option>
                          <option value="2" {{ $question->level == 2 ? 'selected' : '' }}>الثاني الثانوي</option>
                        </select>
                        @error('level')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      ...
                      <div class="d-flex justify-content-between" style="direction:rtl">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Choice 1" name="c1" value="{{ $question->c1 }}">
                          @error('c1')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>  
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Choice 2" name="c2" value="{{ $question->c2 }}">
                          @error('c2')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>  
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Choice 3" name="c3" value="{{ $question->c3 }}">
                          @error('c3')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>  
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Choice 4" name="c4" value="{{ $question->c4 }}">
                          @error('c4')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>  
                        ...
                        <div class="mb-3">
                          ...
                          <select class="form-control" id="basic-default-fullname" name="answer">
                            <option value="1" {{ $question->answer == 1 ? 'selected' : '' }}>1</option>
                            <option value="2" {{ $question->answer == 2 ? 'selected' : '' }}>2</option>
                            <option value="3" {{ $question->answer == 3 ? 'selected' : '' }}>3</option>
                            <option value="4" {{ $question->answer == 4 ? 'selected' : '' }}>4</option>
                          </select>
                          @error('answer')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Lesson</label>
                          <input type="text" style="width=100%" class="form-control" id="basic-default-fullname" placeholder="lesson" name="lesson" value="{{ $question->lesson }}">
                          @error('lesson')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>  
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Answer Explain" name="answer_explain" value="{{ $question->answer_explain }}">
