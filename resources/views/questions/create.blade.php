              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-4">Add Quistion</h4>
                    <small class="text-muted float-end">Questions</small>
                  </div>
                  <div class="card-body">
                    ...
                    <form method="POST" id="questionForm" enctype="multipart/form-data">
                      ...
                      <div class="d-flex">
                        ...
                        <div class="d-flex justify-content-start">  
                          <button type="button" class="btn btn-primary mr-2" onclick="submitQuestionForm('{{ request()->segment(2) }}')">Add Question</button>
                          <a href="/exams/{{ request()->segment(2) }}/questions" type="button" class="btn btn-dark ml-2">Go Back</a>
                        </div>
                    </form>
                  </div>
                </div>
...
function submitQuestionForm(quizId) {
  console.log(quizId);
