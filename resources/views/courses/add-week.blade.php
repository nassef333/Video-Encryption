            ...
            <div class="container-fluid flex-grow-1 container-p-y">
              ...
              <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="/submitWeek" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="d-flex justify-content-between">
                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-fullname">Name</label>
                                    <input type="text" name="courseId" id="" value="{{ request()->segment(2) }}" hidden>
                                    <input type="text" class="form-control" id="basic-default-fullname" placeholder="name" name="name" required>
                                    <input type="text" class="form-control" id="basic-default-fullname" placeholder="name" name="course_id" value="{{ $id }}" hidden>
                                    @error('name')
