...
<div class="card">
  <h2 class="card-header text-center">Courses</h2>
  <p class="text-center">Total Courses: {{ $courses->total() }}</p>
  <div class="card-body">
    <div class="search mt-2 mb-5">
        <div class="buttons mb-2">
          <a href="/courses/create" type="button" class="btn btn-outline-primary btn-sm">+ Add courses</a>
        </div>
      <div class="buttons mb-2">
    ...
    <div class="d-flex justify-content-center">
      <p>Page {{ $courses->currentPage() }} of {{ $courses->lastPage() }}</p>
    </div>
