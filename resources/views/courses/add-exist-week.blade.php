            ...
            <div class="container-fluid flex-grow-1 container-p-y">
              ...
              <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="/submit-exist-week" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="d-flex justify-content-between">
                                <div class="mb-3 w-100">
                                    <label class="form-label" for="basic-default-fullname">Choose Week</label>
                                    <input type="text" name="courseId" id="courseId" value="{{ request()->segment(2) }}" hidden>
                                    <select name="weeks_id" id="weekId" class="form-control">
