...
<div class="card">
  <h2 class="card-header text-center">Exam Students</h2>
  ...
  <div class="card-body">
    ...
    <form action="/exams/{{ request()->segment(2) }}/students" method="GET" class="form-inline">
      @csrf
  ...
  <div class="modal-dialog" role="document">
    ...
    <script>
      ...
      function deleteProduct(ProductId) {
        $.ajax({
          url: '/exams/students/clear/' + ProductId,
          type: 'GET',
          data: {
            _token: '{{ csrf_token() }}'
          },
