            ...
            <div class="container-fluid flex-grow-1 container-p-y">
              ...
              <div id="accordionIcon" class="accordion mt-3 accordion-without-arrow">
                ...
                <div class="accordion-item card">
                  <h2 class="accordion-header text-body d-flex justify-content-between" id="heading{{$index}}">
                    <a href="/weeks/16/content">
                      <button type="button" class="accordion-button collapsed">
                        <!-- Icons based on item type... -->
                        @if ($item['type'] == "video")
                          <i class="fa-regular fa-circle-play fa-lg m-2"></i>
                        @elseif ($item['type'] == "quiz")
                          <i class="fa-solid fa-book fa-lg m-2"></i>
                        @elseif ($item['type'] == "homework")
                          <i class="fa-solid fa-book-open-reader fa-lg m-2"></i>
                        @elseif ($item['type'] == "material")
                          <i class="fa-regular fa-file-pdf fa-lg m-2"></i>
                        @endif  
                        {{ $item['name'] }}
                      </button>
                    </a>
                      <input type="hidden" name="sort[]" value="{{ $loop->index + 1 }}">
              ...
              @endforeach
                ...
                <input type="text" name="week_id" value="{{ $week->id }}" hidden>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const sortable = new Sortable(accordionContainer, {
        ...
        onEnd: function (event) {
          // Update the hidden input field with the new sort order
      ...
      form.addEventListener("submit", function (event) {
        // Submit the form to save the new sorting order
