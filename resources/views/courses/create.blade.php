              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted float-end">Course</small>
                  </div>
                  <div class="card-body">
                    <form action="/courses" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="Enter name" name="name" required>
                        @error('name')
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="description" name="description" required>
                        @error('description')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="imageInput" name="img" accept="image/*" placeholder="Upload Image" onchange="previewImage(event)" required>
                      </div>
                      <div class="d-flex">
                        <div class="mb-3 w-50">
                          <label class="form-label" for="basic-default-fullname">Price</label>
                          <input type="number" class="form-control" id="basic-default-fullname" placeholder="price" name="price" required>
                          @error('price')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>
                        <div class="mb-3 w-50">
                          ...
                          <select class="form-control" id="basic-default-fullname" name="level" required>
