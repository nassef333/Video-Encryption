              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-4">Edit {{$course->name}}</h4>
                  ...
                  <div class="card-body">
                    <form action="/courses/{{$course->id}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="Enter name" name="name" value="{{ $course->name}}">
                        @error('name')
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="description" name="description" value="{{ $course->description}}">
                        @error('description')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <div id="imagePreview" class="overflow-hidden">
                          <img src="{{ asset("storage/".$course->img)}}" alt="{{ $course->name }}" style="width: 100%; height: auto;">
                        </div> 
                      ...
                      <div class="d-flex">
                        <div class="mb-3 w-50">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="price" name="price" value="{{ $course->price}}">
                          @error('price')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>
                        <div class="mb-3 w-50">
                          ...
                          <select class="form-control" id="basic-default-fullname" name="level">
                            <option value="1" {{ $course->level == 1 ? 'selected' : '' }}>الأول الثانوي</option>
                            <option value="2" {{ $course->level == 2 ? 'selected' : '' }}>الثاني الثانوي</option>
                          </select>                          @error('level')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>
