              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-4">Add Material</h4>
                    <small class="text-muted float-end">Materials</small>
                  </div>
                  <div class="card-body">
                    <form action="/submitMaterial" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="basic-default-fullname" placeholder="File" name="cdn" required>
                        @error('cdn')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div> 
