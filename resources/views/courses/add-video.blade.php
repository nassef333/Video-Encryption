                  ...
                  <div class="card-body">
                    <form action="/submitVideo" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="video title" name="title" required>
                        @error('title')
                      ...
                      <div class="d-flex">
                        <div class="mb-3 w-50">
                          ...
                          <input type="number" class="form-control" id="basic-default-fullname" placeholder="number of views" name="noviews" required>
                          @error('noviews')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>  
                        <div class="mb-3 w-50">
                          ...
                          <input type="number" class="form-control" id="basic-default-fullname" placeholder="Time Between Views" name="minutes_views" required>
                          @error('minutes_views')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                        </div>      
                      ...
                      <div class="d-flex">                   
                        <div class="mb-3 w-50">
                          ...
                          <select class="form-control" id="basic-default-fullname" name="type" required>
                        ...
                        <div class="mb-3 w-50">
                          <label class="form-label" for="basic-default-fullname">Video Duration</label>
                          <input type="number" class="form-control" id="basic-default-fullname" placeholder="Video Duration" name="video_duration" required>
