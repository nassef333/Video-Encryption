              ...
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="#" class="menu-link">
                    <div data-i18n="Error">Add Swiper</div>
                  </a>
                </li>                
                <li class="menu-item">
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted float-end">Areas</small>
                  </div>
                  <div class="card-body">
                    <form action="/admin/swipers" method="POST" enctype="multipart/form-data">
                        @csrf
                      <div class="mb-3">
                        <label class="form-label" for="basic-default-fullname">Title</label>
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="title" name="title" value="{{ old('title') }}">
                        @error('title')
                      ...
                      <div class="mb-3">
                        ...
                        <input type="file" step="any" class="form-control" id="basic-default-fullname" placeholder="image" name="image" value="{{ old('image') }}">
                        @error('image')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div> 
                      ...
                      <button type="submit" class="btn btn-primary">Add Swiper</button>
                    </form>
                  </div>
                </div>
              </div>
